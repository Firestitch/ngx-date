(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("@firestitch/date", ["@angular/core", "@angular/common"], factory);
	else if(typeof exports === 'object')
		exports["@firestitch/date"] = factory(require("@angular/core"), require("@angular/common"));
	else
		root["@firestitch/date"] = factory(root["@angular/core"], root["@angular/common"]);
...
var fsdate_pipe_1 = __webpack_require__("./fsdate.pipe.ts");
var fsdate_service_1 = __webpack_require__("./fsdate.service.ts");
var fsdateago_pipe_1 = __webpack_require__("./fsdateago.pipe.ts");
...
var FsDatePipe = (function () {
    function FsDatePipe(FsDate) {
        this.FsDate = FsDate;
    }
    FsDatePipe.prototype.transform = function (value, format) {
        return this.FsDate.format(value, format);
    };
    FsDatePipe = __decorate([
        core_1.Pipe({
            name: 'fsDate'
        }),
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__("./fs-date.module.ts"));
__export(__webpack_require__("./fsdate.pipe.ts"));
__export(__webpack_require__("./fsdate.service.ts"));
__export(__webpack_require__("./fsdate.timezones.ts"));
__export(__webpack_require__("./fsdateago.pipe.ts"));
